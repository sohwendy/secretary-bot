  ...
  fetch: async(dates) => {
    try {
      ...
      let data = await Promise.all([
        SheetApi.get(reminderConst.file, reminderConst.scope, taskOptions, configConstant[0].fields),
        SheetApi.get(reminderConst.file, reminderConst.scope, momentOptions, configConstant[1].fields)
      ]);
